...
const Sidebar = ({ option, setOption }) => {
  ...
  return (
    <aside
      className={`w-64 md:w-1/6 bg-sidebar-bg text-white p-6 max-h-screen md:block fixed top-30 md:top-0 left-0 bottom-0 right-0 z-10`}
    >
      ...
      <div className="mt-16">
        <div className="mb-6">
          ...
          <ul>
            ...
            <li className="mb-2" onClick={() => handleClick('AddProfile')}>
              <a href="#" className="text-gray-300 hover:text-white">
                Add User Profile
              </a>
            </li>
