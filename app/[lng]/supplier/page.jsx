            ...
            <div className="md:w-1/2 bg-white">
                <div className='p-6 md:p-20'>
                    ...
                    <form>
                        ...
                        <div className="mb-4">
                            <label htmlFor="industry" className="block mb-2 font-medium">I want to:</label>
                            <select id="industry" className="bg-gray-100 appearance-none border-2 border-gray-100 rounded w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" type="text">
                                <option value="sell-prod">Sell my product</option>
                                <option value="financing">Getg Financing</option>
                                <option value="both">Both</option>
                            </select>
                        </div>
                        <div className="mb-4">
                            <label htmlFor="additionalInfo" className="block mb-2 font-medium">Additional Info:</label>
                            <textarea id="additionalInfo" placeholder="Tell us more about what you're doing!" className="w-full bg-gray-100 appearance-none border-2 border-gray-200 rounded w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" type="text"></textarea>
                        </div>
