    ...
    <div>
      <div className="flex p-5 justify-between flex-wrap">
        <div className="flex items-center mb-10 sm:mb-0 mr-32">
          <Link href={`/`}>
            <img src="/arrow-back.png" alt="back" className="w-10 h-10" />
          </Link>
        </div>
      ...
      <div className="flex">
        <div
          className={`mb-2 ml-10 sm:w-auto sm:ml-10 ${
            !showFilters ? 'hidden sm:block' : '' // Hide filters content on mobile if showFilters is false
          }`}
        >
